...
namespace internal {
    ...
    static constexpr inline const char* DX_ModelColorNoLightVertexShader = R"(
        struct Output {
            float4 svpos : SV_POSITION;
            float4 color : COLOR;
        };
    ...
    static constexpr inline const char* DX_ModelColorNoLightFragmentShader = R"(
        struct Output {
            float4 svpos : SV_POSITION;
            float4 color : COLOR;
        };
    ...
    static constexpr inline const char* DX_ModelTextureNoLightVertexShader = R"(
        struct Output {
            float4 svpos : SV_POSITION;
            float2 uv : TEXCOORD;
        };
    ...
    static constexpr inline const char* DX_ModelTextureNoLightFragmentShader = R"(
        struct Output {
            float4 svpos : SV_POSITION;
            float2 uv : TEXCOORD;
        };
